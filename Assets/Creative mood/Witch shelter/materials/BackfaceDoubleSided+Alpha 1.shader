...
/*SF_DATA;ver:1.27;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,lico:1,lgpr:1,limd:1,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:False,hqlp:False,rprd:False,enco:True,rmgx:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:0,bsrc:3,bdst:7,dpts:2,wrdp:True,dith:0,rfrpo:True,rfrpn:Refraction,coma:15,ufog:False,aust:False,igpj:True,qofs:200,qpre:3,rntp:2,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False;n:type:ShaderForge.SFN_Final,id:4013,x:33305,y:32171,varname:node_4013,prsc:2|diff-5711-OUT,emission-8060-OUT,alpha-8736-OUT;n:type:ShaderForge.SFN_Tex2d,id:5431,x:32048,y:32452,ptovrint:False,ptlb:baseColor,ptin:_baseColor,varname:node_5431,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:False;n:type:ShaderForge.SFN_VertexColor,id:3407,x:31765,y:32545,varname:node_3407,prsc:2;n:type:ShaderForge.SFN_Slider,id:8951,x:32120,y:32131,ptovrint:False,ptlb:Hue,ptin:_Hue,varname:node_8951,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.5,max:1;n:type:ShaderForge.SFN_HsvToRgb,id:9641,x:32425,y:32178,varname:node_9641,prsc:2|H-8951-OUT,S-2748-OUT,V-5848-OUT;n:type:ShaderForge.SFN_Slider,id:2748,x:32120,y:32227,ptovrint:False,ptlb:Power,ptin:_Power,varname:_Hue_copy,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0,max:1;n:type:ShaderForge.SFN_Slider,id:5848,x:32120,y:32322,ptovrint:False,ptlb:Lightness,ptin:_Lightness,varname:_Hue_copy_copy,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1,max:2;n:type:ShaderForge.SFN_Multiply,id:1303,x:32347,y:32485,varname:node_1303,prsc:2|A-9641-OUT,B-5431-RGB;n:type:ShaderForge.SFN_Slider,id:7753,x:31836,y:32859,ptovrint:False,ptlb:Effect,ptin:_Effect,varname:node_7753,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.3528343,max:1;n:type:ShaderForge.SFN_Slider,id:3641,x:32580,y:32923,ptovrint:False,ptlb:Opacity,ptin:_Opacity,varname:node_3641,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.1775361,max:1;n:type:ShaderForge.SFN_Lerp,id:8736,x:32544,y:32654,varname:node_8736,prsc:2|A-3407-A,B-4639-OUT,T-3641-OUT;n:type:ShaderForge.SFN_Lerp,id:3475,x:32174,y:32672,varname:node_3475,prsc:2|A-3407-RGB,B-4639-OUT,T-7753-OUT;n:type:ShaderForge.SFN_Multiply,id:5711,x:32766,y:32427,varname:node_5711,prsc:2|A-8260-OUT,B-3475-OUT;n:type:ShaderForge.SFN_ValueProperty,id:4639,x:31836,y:32766,ptovrint:False,ptlb:EmptyValue1,ptin:_EmptyValue1,varname:node_4639,prsc:2,glob:False,taghide:True,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:1;n:type:ShaderForge.SFN_Slider,id:3837,x:32587,y:32062,ptovrint:False,ptlb:Saturation,ptin:_Saturation,varname:node_3837,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1,max:1;n:type:ShaderForge.SFN_RgbToHsv,id:5497,x:32631,y:32199,varname:node_5497,prsc:2|IN-1303-OUT;n:type:ShaderForge.SFN_Lerp,id:8260,x:32996,y:32191,varname:node_8260,prsc:2|A-5497-VOUT,B-1303-OUT,T-3837-OUT;n:type:ShaderForge.SFN_Power,id:4073,x:32964,y:32510,varname:node_4073,prsc:2|VAL-8865-OUT,EXP-3407-A;n:type:ShaderForge.SFN_Slider,id:8865,x:32850,y:32801,ptovrint:False,ptlb:Emission,ptin:_Emission,varname:_Opacity_copy,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.07836132,max:1;n:type:ShaderForge.SFN_Color,id:5092,x:33191,y:32716,ptovrint:False,ptlb:EmissionColor,ptin:_EmissionColor,varname:node_5092,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:1,c2:0.9310343,c3:0,c4:1;n:type:ShaderForge.SFN_Multiply,id:8060,x:33110,y:32510,varname:node_8060,prsc:2|A-5092-RGB,B-4073-OUT;proporder:5431-8951-2748-3837-5848-7753-3641-4639-8865-5092;pass:END;sub:END;*/

Shader "Creativemood/SideDoubleSided+Alpha" {
    Properties {
